...
/*   Updated: 2024/03/19 10:59:56 by fde-carv         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Harl::_Debug(void)
{
	...
	std::cout << "-triple-pickle-specialketchup burger. I really do!\033[0m";
}
...
void	Harl::_Info(void)
{
	...
	std::cout << "If you did, I wouldn’t be asking for more!\033[0m";
}

void	Harl::_Warning(void)
{
	std::cout << "\033[1;33mI think I deserve to have some extra bacon for free. ";
	std::cout << "I’ve been coming for years whereas you started working here since last month.\033[0m";
}

void	Harl::_Error(void)
{
	std::cout << "\033[1;33mThis is unacceptable! I want to speak to the manager now.\033[0m";
}
