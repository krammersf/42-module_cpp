...
/*   Updated: 2024/03/22 09:15:55 by fde-carv         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ScavTrap::attack(const std::string& target)
{
	...
	{
		std::cout << "ScavTrap " << "[" << this->_name << "] " << " is out of energy and is out of action!!!" << std::endl;
		return ;
	}
	if (this->_hitPoints == 0)
	{
		std::cout << "ScavTrap " << "[" << this->_name << "] " << " is already " << RED << "DEAD" << RESET << std::endl;
		return ;
	}
